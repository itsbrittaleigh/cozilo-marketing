<template>
  <base-page>
    <template slot="content">
      ...
      <section class="value-section buy bg-lightblue padded-section content">
        <div class="container">
          <div class="text">
      ...
      <section class="value-section sell bg-orange padded-section content reverse-desktop">
        <div class="container">
          <div class="text">
            <div class="section-header-icon bg-darkblue hidden">
      ...
      <section class="value-section trade bg-lightblue padded-section content">
        <div class="container">
          <div class="text">
            <div class="section-header-icon bg-darkblue hidden">
